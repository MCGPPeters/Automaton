...
/// </summary>
/// <remarks>
/// The User aggregate currently produces no effects — all side effects
/// (email verification, notifications) are handled at the application layer.
...
/// <list type="number">
///   <item><c>Initialize</c> — creates an unregistered user state</item>
...
/// <list type="bullet">
///   <item>Register is only accepted once (guard: <c>!Registered</c>)</item>
///   <item>All other commands require registration (guard: <c>Registered</c>)</item>
///   <item>Cannot follow self</item>
///   <item>Cannot follow someone already followed</item>
///   <item>Cannot unfollow someone not followed</item>
/// </list>
/// </para>
/// </remarks>
public class User
