...
// =============================================================================
// Tests authentication with InteractiveAuto: starts server-side (WebSocket),
// then transitions to WASM once downloaded. API calls flow through the
// Kestrel reverse proxy both before and after WASM takeover.
// =============================================================================
