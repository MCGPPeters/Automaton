...
// defined in Abies.Server.Transport. This is the "adapter" in the
...
//
// See also:
//   - Abies.Server/Transport.cs — delegate type definitions
//   - Abies.Server/Session.cs — consumes these delegates
...
{
    private static readonly ActivitySource _activitySource = new("Abies.Server.Kestrel.WebSocketTransport");
    ...
    {
        using var activity = _activitySource.StartActivity("Abies.WebSocket.SendPatches");
    ...
    {
        using var activity = _activitySource.StartActivity("Abies.WebSocket.ReceiveEvent");
