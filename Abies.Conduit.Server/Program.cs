...
//
// This is the server-side equivalent of Abies.Conduit.Wasm — same program,
// different host. The ConduitProgram is defined in the shared Abies.Conduit.App
// library and is platform-agnostic.
//
// Usage:
//     dotnet run --project Abies.Conduit.Server
//     → http://localhost:5100
// =============================================================================
