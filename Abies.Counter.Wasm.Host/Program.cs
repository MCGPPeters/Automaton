...
//
// The CounterProgram is defined in the shared Abies.Counter library and is
// platform-agnostic. The same program runs in both WASM (Abies.Counter.Wasm)
...
//
// Usage:
//     dotnet run --project Abies.Counter.Wasm.Host
//     → http://localhost:5000
//
// Prerequisites:
...
// The path points to the published output of the Abies.Counter.Wasm project.
...
var wasmAppBundlePath = Path.GetFullPath(Path.Combine(
    ...
    "Abies.Counter.Wasm", "bin", configuration,
