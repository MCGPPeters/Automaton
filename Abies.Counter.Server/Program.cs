...
//
// This is the server-side equivalent of Abies.Counter.Wasm — same program,
// different host. The CounterProgram is defined in the shared Abies.Counter
// library and is platform-agnostic.
//
// Usage:
//     dotnet run --project Abies.Counter.Server
//     → http://localhost:5000
// =============================================================================
